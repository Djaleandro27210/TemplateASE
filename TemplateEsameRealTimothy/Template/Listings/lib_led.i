...
void LED_init(void) {
 ((LPC_PINCON_TypeDef *) ((0x40000000UL) + 0x2C000) )->PINSEL4 &= 0xFFFF0000; //PIN mode GPIO (00b value per P2.0 to P2.7)
 ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR |= 0x000000FF; //P2.0...P2.7 Output (LEDs on PORT2 defined as Output)

 ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOCLR = 0x000000FF; //all LEDs off

 led_value = 0;
}

void LED_deinit(void) {
 ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIODIR &= 0xFFFFFF00; //P2.0...P2.7 Output LEDs on PORT2 defined as Output
}
