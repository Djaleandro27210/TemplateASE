...
int main (void) {
 ...
 //power_on_timer2(); // or ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) ) -> PCONP |= (1 << 22); // TURN ON TIMER 2
 //power_on_timer3(); // or ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) ) -> PCONP |= (1 << 23); // TURN ON TIMER 3
 ...
 //init_timer(0, 0, 0, (1 << 0), 0x017D7840);
# 73 "Source/sample.c"
 //init_timer(2,0,0,(1 << 1),0x7A120); //100Hz
 //enable_timer(2);


 //per impostare un livello di priorita (da 0 il più importante a 3 il meno importante)
 //__NVIC_SetPriority(TIMER0_IRQn, 0); // Timer0 priorità massima (0)
 //__NVIC_SetPriority(RIT_IRQn, 3);

 ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCON |= 0x1;
 ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCON &= 0xFFFFFFFFD;
