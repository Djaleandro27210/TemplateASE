...
{
 ((LPC_SC_TypeDef *) ((0x40080000UL) + 0x7C000) )->PCLKSEL1 &= ~(3<<26);
...
unsigned int get_RIT_value() {
 return ((LPC_RIT_TypeDef *) ((0x40080000UL) + 0x30000) )->RICOUNTER;
}
