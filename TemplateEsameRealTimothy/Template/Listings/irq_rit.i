...
void LED_OffAll(void);
void LED_Out_Range(unsigned int value, unsigned char from_led_num, unsigned char to_led_num);
# 3 "Source/RIT\\../sample.h" 2

# 1 "Source/RIT\\..\\timer/timer.h" 1
# 14 "Source/RIT\\..\\timer/timer.h"
...
void RIT_IRQHandler(void)
{
 ...
 if(down_0 !=0) {
  down_0++;
  if((((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN & (1<<10)) == 0){ //bottone premuto
   switch(down_0) {
    case 2:
     //short press
   ...
   if(toRelease_down_0){
    //codice da eseguire quando il bottone è rilasciato
 ...
 if(down_1 !=0) {
  down_1++;
  if((((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN & (1<<11)) == 0){ //bottone premuto
   switch(down_1){
    case 2:
     //short press
 ...
 if(down_2 !=0) {
  down_2++;
  if((((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN & (1<<12)) == 0){ //bottone premuto
   switch(down_2){
    case 2:
     //short press
