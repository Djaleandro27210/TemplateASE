...
uint32_t init_timer ( uint8_t timer_num, uint32_t Prescaler, uint8_t MatchReg, uint8_t SRImatchReg, uint32_t TimerInterval )
{
  ...
  if (MatchReg == 0){
   ...
   ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->MCR |= SRImatchReg << 3*MatchReg;
  }
  else if (MatchReg == 1){
   ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->MR1 = TimerInterval;
   ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->MCR |= SRImatchReg << 3*MatchReg;
  }
  else if (MatchReg == 2){
   ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->MR2 = TimerInterval;
   ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->MCR |= SRImatchReg << 3*MatchReg;
  }
  else if (MatchReg == 3){
   ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->MR3 = TimerInterval;
   ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->MCR |= SRImatchReg << 3*MatchReg;
  }
  ...
  return (0);
   ...
   {
  ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )-> PR = Prescaler;

  if (MatchReg == 0){
   ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->MR0 = TimerInterval;
   ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->MCR |= SRImatchReg << 3*MatchReg;
  }
  else if (MatchReg == 1){
   ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->MR1 = TimerInterval;
   ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->MCR |= SRImatchReg << 3*MatchReg;
  }
  else if (MatchReg == 2){
   ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->MR2 = TimerInterval;
   ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->MCR |= SRImatchReg << 3*MatchReg;
  }
  else if (MatchReg == 3){
   ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->MR3 = TimerInterval;
   ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->MCR |= SRImatchReg << 3*MatchReg;
  }
 ...
 // TIMER 2
   ...
   {
  ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )-> PR = Prescaler;

  if (MatchReg == 0){
   ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->MR0 = TimerInterval;
   ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->MCR |= SRImatchReg << 3*MatchReg;
  }
  else if (MatchReg == 1){
   ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->MR1 = TimerInterval;
   ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->MCR |= SRImatchReg << 3*MatchReg;
  }
  else if (MatchReg == 2){
   ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->MR2 = TimerInterval;
   ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->MCR |= SRImatchReg << 3*MatchReg;
  }
  else if (MatchReg == 3){
   ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->MR3 = TimerInterval;
   ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->MCR |= SRImatchReg << 3*MatchReg;
  }
 ...
 // TIMER 3
   ...
   {
  ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )-> PR = Prescaler;

  if (MatchReg == 0){
   ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->MR0 = TimerInterval;
   ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->MCR |= SRImatchReg << 3*MatchReg;
  }
  else if (MatchReg == 1){
   ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->MR1 = TimerInterval;
   ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->MCR |= SRImatchReg << 3*MatchReg;
  }
  else if (MatchReg == 2){
   ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->MR2 = TimerInterval;
   ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->MCR |= SRImatchReg << 3*MatchReg;
  }
  else if (MatchReg == 3){
   ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->MR3 = TimerInterval;
   ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->MCR |= SRImatchReg << 3*MatchReg;
  }
  __NVIC_EnableIRQ(TIMER3_IRQn);
  __NVIC_SetPriority(TIMER3_IRQn, 0);
  return (0);
   }
 return (1);
}
# 301 "Source/timer/lib_timer.c"
void toggle_timer( uint8_t timer_num ) {
 if ( timer_num == 0 )
 {
  ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->TCR = !((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->TCR;
 }
 else if (timer_num == 1)
 {
  ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->TCR = !((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->TCR;
 }
 else if (timer_num == 2)
 {
  ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->TCR = !((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->TCR;
 }
 else if (timer_num == 3)
 {
  ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->TCR = !((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->TCR;
 }
 return;
}
# 338 "Source/timer/lib_timer.c"
unsigned int get_timer_value(uint8_t timer_num) {
 if ( timer_num == 0 )
 {
  return ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->TC;
 }
 else if (timer_num == 1)
 {
  return ((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->TC;
 }
 else if (timer_num == 2)
 {
  return ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->TC;
 }
 else if (timer_num == 3)
 {
  return ((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->TC;
 }
 return -1;
}
# 379 "Source/timer/lib_timer.c"
float get_timer_value_in_sec(uint8_t timer_num) {

 switch (timer_num) {
         case 0:
              return (float) (((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x04000) )->TC) / 25000000;
         case 1:
              return (float) (((LPC_TIM_TypeDef *) ((0x40000000UL) + 0x08000) )->TC) / 25000000;
          case 2:
              return (float) (((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x10000) )->TC) / 25000000;
         case 3:
              return (float) (((LPC_TIM_TypeDef *) ((0x40080000UL) + 0x14000) )->TC) / 25000000;
          default:
              return -1;
     }
}
# 411 "Source/timer/lib_timer.c"
uint32_t is_timer_enabled ( uint8_t timer_num){
