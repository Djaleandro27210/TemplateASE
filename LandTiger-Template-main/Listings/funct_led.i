# 1 "Source/led/funct_led.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 404 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "Source/led/funct_led.c" 2
# 11 "Source/led/funct_led.c"
...
void LED_On(unsigned int num) {
 ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN |= led_mask[num];
 led_value = ((LPC_GPIO_TypeDef *) ((0x2009C000UL) + 0x00040) )->FIOPIN;
}
...
void LED_Out_Range(unsigned int value, uint8_t from_led_num, uint8_t to_led_num){
 int i;
 int j;
 if (to_led_num < from_led_num || to_led_num >= 8) return;
